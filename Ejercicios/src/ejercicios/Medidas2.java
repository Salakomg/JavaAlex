...
public class Medidas2 {
	...
	public static void main(String[] args) {
		...
		String pregunta = JOptionPane.showInputDialog("¿Dime una cantidad en kilometros y lo pasare s todas las unidades");
		
		int a = Integer.parseInt(pregunta);
		
	    int b = a * 10;
	     
	    String opcion = JOptionPane.showInputDialog("Ahora te lo pasare en la unidad que tu me digas(hm, dam, m, dm, cm, mm)");
